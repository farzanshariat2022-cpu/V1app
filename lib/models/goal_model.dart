...
class GoalModel {
  ...
  final String? parentId; // null یعنی ریشه (Goal یا Project مستقل)
  final int order;
  final DateTime createdAt;

  /// پیشرفت دستی ۰ تا ۱۰۰ - مخصوص گره‌های نوع «پروژه» طبق بخش ۱۰ پرامپت
  /// (مثلا «طراحی UI: ۷۰٪»). برای بقیه‌ی انواع استفاده نمی‌شود.
  ...
  factory GoalModel.fromDoc(DocumentSnapshot<Map<String, dynamic>> doc) {
    ...
    return GoalModel(
      ...
      manualProgress: map['manualProgress'] as int?,
    );
  }
